...
author = "CSPAC"
content_authors = ["Lukas Lazarek", "Nathan Greiner"]
...
- Can be loaded with funds and changed to a full-fare card once you are no longer enrolled full-time
...
- [*Public Transport*](https://www.google.com/maps/dir/O'Hare,+Chicago,+IL/northwestern/@42.0019654,-87.81614,12z/am=t/data=!4m14!4m13!1m5!1m1!1s0x880fca0c24ab66f1:0x80202866a0816f8a!2m2!1d-87.8367209!2d41.9772281!1m5!1m1!1s0x880fd00b703e4c39:0x2c37b567fad56106!2m2!1d-87.675267!2d42.0564594!3e3): there are two options
  ...
  - **Option 1: Take the PACE bus directly to Evanston.** *Cost*: $2.25 (see below), *Time*: 1hr.

    - PACE has a bus that you can pick up in the Kiss and Ride. It is **bus 250** and goes directly from there to downtown evanston. It leaves OHare every 20 minutes.

    - To find the Kiss and Ride at OHare, look for signs with that name or ask an airport employee.

    - [*Bus schedule here*](https://www.pacebus.com/route/250)

    - You can pay the fare using cash (exact change!) or by buying a ventra card. You can buy a one-way ventra card or a permanent (“hard”) card for $5. If you decide to buy the hard card, you can register it and get the $5 back in ride credit.

  - **Option 2: Take the CTA (trains and buses)**. This can take you to anywhere in Chicago as well as to Evanston. *Cost*: $5 - $8, *Time*: varies by route from 1.5hrs to 2.5hrs.

    - You’ll have multiple options for how to get wherever you’re going with a combination of L-train and bus

      - If you’re going to the north side of Chicago (or Evanston), probably the easiest route (though not the fastest) is to take the Blue line train (there’s only one way to go from OHare) and at Washington transfer to the Red line toward Howard. Then if you’re going to Evanston you continue from Howard north on the Purple line.

    - It typically takes 1.5-2hrs to get from O’Hare to Evanston using this method

    - You need to buy a Ventra card to use this method, which you can buy at automated kiosks at the entrance to all of the L trains.

    - L-train: just follow directions in the airport for “CTA trains” or “L trains”

    - Bus: Look at the names on the bus stop sign. You’ll see names and these correspond to direction; the names are the only thing you need to pay attention to. For example the 77 bus runs East toward Diversity/Lakeshore and when the 77 bus rus west it is toward Belmont/Cumberland.

- Rideshare: 40min by rideshare (typical fare ~$30-50)
...
- Most CS courses will be entirely online, and some will be hybrid with some in-person parts. The course modality (online, hybrid, in-person) should be clearly marked in the course catalog and on CAESAR.

- What doing research remotely looks like depends highly on your specific area, but research is continuing across the department.
...
When registration is open, you can register for classes in [*CAESAR*](https://caesar.northwestern.edu/) in the “Manage classes” section. You need to search for the classes you want to register in, add them to your cart, and then go to your cart and select them and enroll.

Many classes will require you to have a permission number to enroll as a PhD student: if that’s the case, just email the professor teaching the course asking for one.

The best place to find out what courses are being offered is the [*Course Listings*](https://www.mccormick.northwestern.edu/computer-science/academics/courses/) page on the website. It provides a table outlining all of the courses being offered each academic year, when they’re being offered, who’s teaching them, and summaries of the courses. It’s usually easiest to use that page to decide what you plan to take, and then go into CAESAR to actually enroll.
...
We can work on making one, perhaps with your help. For starters, here’s a possibly-incomplete list of things you should have done off the tops of our heads:

- Formally accept your offer

- Get in touch with your faculty advocate

  - To get to know them, and ask if there’s anything you should be doing to prepare research-wise

- Set up your NetID/NU google accounts

- With the help of your faculty advocate, pick courses for your first quarter

- Read through the [*CS graduate manual*](https://bpb-us-e1.wpmucdn.com/sites.northwestern.edu/dist/1/4730/files/2021/08/cs-phd-manual-2021-aug2.pdf) (in particular the section for your track) and take note of the requirements so you can track your progress. Additionally if you're in CSLS check out [*their manual*](https://docs.google.com/document/d/1rv4VJ2Vf6dJ834HrkDUOMYW_F_Q52Wdi5lUr6iG-grU/edit), if you're in TSB check out [*their manual*](https://media.soc.northwestern.edu/socwp-aws/sites/48/2023/02/17110309/Final-TSB-Handbook-2022-2023.pdf), and if you're on the Computer Engineering track check [*their manual*](https://www.mccormick.northwestern.edu/electrical-computer/documents/2022-23-ce-graduate-manual_edited-august-2022.pdf)
...
- Manna Kitchen: very affordable vegetarian Indian food delivered to campus every weekday. Ordering is done via a whatsapp groupchat, reach out to Nathan Greiner if you're interested in being added!

- [*Kellogg Global Hub*](https://www.kellogg.northwestern.edu/facilities/global-hub.aspx): right next door to Mudd, has a handful of reasonably priced ($10-15 a meal) options like pizza, pre-made sushi, a salad bar, made-to-order sandwiches, and a rotating stall.

- Tech Express: mediocre and expensive pre-made sandwiches, salads, sushi etc, and a rotating fresh option from local evanston restaurants. Located on North-East end of Tech 2nd floor.

- Farmer’s fridge: a vending machine on the 2nd floor of Mudd (by the south stairs) with pretty-ok salads and other wholesome boxed meals and snacks. This is the only real food available late at night on campus.

- Norris cafeteria: mediocre and expensive dining-hall style food options like pizza, Asian-ish, burgers. In the basement of the Norris student center.

- Sargent Hall: all-you-can-eat dining hall, cheapest way to eat here is to buy the faculty/staff meal plan on northwestern dining for $85 which gives you 10 swipes.

- [*Tomate*](https://www.tomatefreshkitchen.com/): a small local counter-serve place by Noyes CTA station with burritos, tacos, empanadas, and more. The food is delicious and really cheap. Order online before walking there otherwise you might have to wait in line -- it’s very popular.

- D&D’s: a family-owned grocery store by Noyes CTA station with a deli and hotdog shop.
...
- Farmer’s fridge (see previous answer)
...
Feel free to ask them in the student slack or email CSPAC: <cspac@u.northwestern.edu>
